...
<div class="review-block">
	<div class="review-text">
		...
		<div class="review-block-title"><span class="review-block-name"><a href="#"><?echo $arItem["NAME"]?></a></span><span class="review-block-description"><?echo $arItem["PROPERTIES"]["position"]["VALUE"]?><?echo $arItem["PROPERTIES"]["Company"]["VALUE"]?></span></div>
